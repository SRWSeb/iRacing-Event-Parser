...
echo "Connected successfully!";
  ...
  function enterResult($conn) {
    ...
    $datetime2 = "'2020-05-15 14:45:00'";

    $sql_eventInfo = "INSERT INTO events (time_and_day, lone_event, league_id, season_id, teamevent, multiclass) VALUES ($finaldatetime, FALSE, " . $leagueInfo[1] . ", " . $leagueInfo[3] . ", FALSE, FALSE);";
